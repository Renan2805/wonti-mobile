...
const SignIn_3 = ({navigation}: RootStackScreenProps<'SignIn_3e'>) => {
  ...
  const doSignUp = async () => {
    try {
      ...
      const data = await getData('dados-empresariais')
      const enderecoObj: Endereco = {
        rua: rua,
        numero: numero,
        complemento: complemento,
  ...
  return (
    <View style={{height: '100%'}}>
      ...
      <View style={styles.content}>
        ...
        <View style={{width: '90%'}}>
          <NextButton _onPress={() => _validate()} text={'Cadastrar'} _isLoading={isLoading}/>
        </View>
        <Footer />
      </View>
    </View>
